...
public class boomutil implements VisionProcessor {
     ...
     */
    public boomutil(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
