...
@TeleOp
public class Qual2_NO extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            int reset = 0;
            double armPositionBackdrop = 0.05;
            double armPositionPixel = 0.08;
            ...
            if (gamepad1.right_stick_button) { // INTAKE PIXEL IN //
            ...
            } else if (gamepad1.right_bumper) { // PIXEL IN //
                intakeMotor.setPower(1);

            } else if (gamepad1.left_bumper) { // PIXEL OUT //
                intakeMotor.setPower(-1);

            } else if (gamepad1.a) { // 2 PIXEL STACK //
            ...
            } else if (gamepad1.b) { // 3 PIXEL STACK //
...
//            }
            ...
            // // ARM MOVEMENT //
            // if (gamepad2.dpad_up) { // STICK UP = FLIP TO BACKDROP //
            //     leftArm.setPosition(armPositionBackdrop + 0.031);
            //     rightArm.setPosition(armPositionBackdrop - 0.01);
            //     //leftPivot.setPosition(0);
            //     //rightPivot.setPosition(0);

            // } else if (gamepad2.dpad_down) { // STICK DOWN = INITIAL POSITION //
            //     leftArm.setPosition(armPositionPixel + 0.031);
            //     rightArm.setPosition(armPositionPixel);
            ...
            // // ARM PIVOT //
            // if (gamepad2.dpad_left) { // ANGLE OUTAKE OUT //
            //     leftPivot.setPosition(0);
            //     //rightPivot.setPosition(0);

            // } else if (gamepad2.dpad_right) { // ANGLE OUTAKE IN //
            //     leftPivot.setPosition(1);
            //     //rightPivot.setPosition(0);
            ...
            //     wristServo.setPosition(0.14); // 0.195

            // } else if (gamepad2.right_bumper) { // HORIZONTAL  //
            //     wristServo.setPosition(0.474); // 0.859 is for full 180

            // }

            // // SERVO PINCH //
            // if (gamepad2.right_trigger != 0) { // OPEN //
            //     leftPinch.setPosition(0.03);
            //     rightPinch.setPosition(0.03);

            // } else if (gamepad2.left_trigger != 0) { // CLOSED //
            //     leftPinch.setPosition(0.07);
            //     rightPinch.setPosition(0.062);
