...
@TeleOp
public class Qual6 extends LinearOpMode {
...
//            }
                ...
                // Copy & Paste 'If Else' and edit for each sensor, not the else!!

                // Telemetry

                telemetry.addLine("LETS DO THIS!");
                telemetry.addData("Distance:", dl.getDistance(DistanceUnit.CM));
